 ...
 */
@MultipartConfig(location = "D:/DemoUpFile", fileSizeThreshold = 1024 * 1024, // 1 MB Nếu kích thước file upload lơn hơn
																				// threshold sẽ được ghi trực tiếp vào ổ
																				// đĩa thay vì lưu ở memory đệm.
...
public class ServletUploadFile extends HttpServlet {
	...
	private static String uploadPath = "D:/DemoUpFile";
